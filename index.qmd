...
- Caldara & Iacoviello (2022): risiko geopolitik diukur dari frekuensi pemberitaan:
    - share artikel di 10 surat kabar besar yang memuat kata kunci perang/ketegangan/terorisme.
...
```python
raw = pd.read_excel("data/gpr_raw.xls", sheet_name="Sheet1")    # ambil data
...
- kode & slide: [github saya](https://github.com/imedkrisna/geoeconomics/)
